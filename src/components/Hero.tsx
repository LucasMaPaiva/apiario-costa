    ...
    <section id="home" className="relative min-h-screen flex flex-col md:flex-row overflow-hidden pt-20">
      ...
      <div className="w-full md:w-1/2 relative bg-[#F5F2ED] min-h-[400px] md:min-h-screen flex items-center justify-center p-8 md:p-12 lg:p-24">
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-12 text-brand-white">
            <span className="text-xs uppercase tracking-widest mb-2 opacity-80">Safra 2024</span>
            <h3 className="text-2xl md:text-3xl font-serif">A essência dourada da natureza em cada gota.</h3>
          </div>
        </motion.div>
